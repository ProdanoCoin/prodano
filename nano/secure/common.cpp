...
nano::ledger_constants::ledger_constants (nano::work_thresholds & work, nano::networks network_a) :
	...
	genesis (network_a == nano::networks::banano_dev_network ? nano_dev_genesis : network_a == nano::networks::nano_beta_network ? nano_beta_genesis
	...
	final_votes_canary_account (network_a == nano::networks::banano_dev_network ? nano_dev_final_votes_canary_account : network_a == nano::networks::nano_beta_network ? nano_beta_final_votes_canary_account
	...
	final_votes_canary_height (network_a == nano::networks::banano_dev_network ? nano_dev_final_votes_canary_height : network_a == nano::networks::nano_beta_network ? nano_beta_final_votes_canary_height
																																								   ...
																																								   : nano_live_final_votes_canary_height)
{
	...
	debug_assert (!error);
	auto epoch_v2_signer (network_a == nano::networks::banano_dev_network ? nano::dev::genesis_key.pub : network_a == nano::networks::nano_beta_network ? nano_beta_account
